...
:::info Numeric Data Values

Data values in the `data` arrays are automatically converted to numbers. If YAML parses a value as a string (e.g., `"5"` instead of `5`), the plugin will convert it before rendering. You can write values as either numbers or strings and they will work correctly.
